...
export const TITLE_COLOR="Color";
export const TITLE_GENDER="Gender";
export const TITLE_PRICE="Price";
export const TITLE_TYPE="Type";
...
export const genderConst = [
  ...
  export const priceRangeConst = [
    `0- INR 250`,`INR 251 - INR 450`,`ABOVE INR 450`
